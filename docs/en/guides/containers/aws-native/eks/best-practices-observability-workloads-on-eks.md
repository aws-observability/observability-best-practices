...
This section of Observability best practices guide provides you guidance around AWS native best practices for observability of metrics based workloads on Amazon Elastic Kubernetes Service (Amazon EKS).  
