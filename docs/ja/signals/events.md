...
!!! success
	他の重要なメトリクスデータとともにイベントを可視化することで、[イベントと運用メトリクスを相関付ける](./metrics.md#correlate-with-operational-metric-data)ことができます。
...
!!! success
	[key performance indicator](./metrics.md#know-your-key-performance-indicatorskpis-and-measure-them) に関連するイベントをメッセージバスに*すべて*配信することを検討してください。
