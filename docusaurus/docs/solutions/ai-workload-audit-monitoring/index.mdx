...
- You are building, operating, or securing AI workloads on AWS using Amazon Bedrock, Amazon Bedrock AgentCore, or self-hosted models
- You need to establish a complete audit trail for AI model invocations, agent actions, and tool usage
- You are implementing the security dimensions defined in the Generative AI Security Scoping Matrix or the Agentic AI Security Scoping Matrix
- You need to correlate identity, content, and performance data across CloudTrail, Bedrock Model Invocation Logging, and Agent Telemetry (ADOT SDK)
- You want to detect unauthorized access, guardrail modifications, logging disruption, or agent credential access anomalies in near real time
- You are setting up CloudWatch metric filters, alarms, Contributor Insights rules, or cross-pipeline correlation queries for AI workloads
- You need a unified CloudWatch dashboard combining security audit, operational monitoring, and cost attribution for AI workloads
...
- [Generative AI Security Scoping Matrix](https://aws.amazon.com/ai/security/generative-ai-scoping-matrix/) — Security dimensions for generative AI workloads
- [Agentic AI Security Scoping Matrix](https://aws.amazon.com/ai/security/agentic-ai-scoping-matrix/) — Security dimensions for agentic AI systems
- [GenAI Observability on AWS](https://aws-observability.github.io/observability-best-practices/guides/genai/genai-observability-on-aws/) — Deep dive on Bedrock Model Invocation Logging and Agent Telemetry (ADOT SDK) pipelines
- [Custom Dashboards for GenAI Telemetry](https://aws-observability.github.io/observability-best-practices/guides/genai/custom-dashboards-for-genai-telemetry/) — Persona-based dashboards (DevOps, FinOps) with ready-to-use queries
