# Plateforme d'Observability IA multi-cloud - Architecture

## Vue d'ensemble

Ce document decrit l'architecture d'une plateforme d'Observability IA multi-cloud construite sur les services geres AWS. La plateforme fournit une surveillance unifiee, une optimisation des couts et des informations operationnelles pour les charges de travail Large Language Model (LLM) sur plusieurs fournisseurs cloud.
...
## Surveillance du systeme de surveillance
