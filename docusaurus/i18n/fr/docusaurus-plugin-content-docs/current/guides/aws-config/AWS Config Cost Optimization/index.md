...
sidebar_position: 4
---
# Optimisation des couts AWS Config
...
### Recommandations d'optimisation des couts

#### Analyse des couts Config
...
#### Choisir entre l'enregistrement continu et periodique
...
#### Principaux elements de configuration
...
#### Considerations sur la gestion et l'evaluation des regles 
...
#### Optimisation des regles personnalisees et des fonctions Lambda 
...
#### Deduplication des packs de conformite et des regles 
...
#### Optimisation de l'enregistrement des ressources globales dans AWS Config
...
#### Optimisation des services integres 
