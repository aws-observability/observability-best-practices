...
sidebar_position: 1
---
# Exploitation d'AWS Config

### **Activer AWS Config dans toutes les regions de tous les comptes**
...
### Parametres de l'enregistreur AWS Config
...
### Bonnes pratiques de methode de livraison
...
### Administrateur delegue pour AWS Config
