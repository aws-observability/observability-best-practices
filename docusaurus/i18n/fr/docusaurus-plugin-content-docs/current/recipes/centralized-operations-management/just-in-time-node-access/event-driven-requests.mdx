...
# Integration EventBridge avec JITNA

Lors de l'utilisation de l'acces juste-a-temps aux noeuds (JITNA), trois types d'evenements sont emis vers [EventBridge](https://aws.amazon.com/eventbridge/) lorsque des demandes d'acces de session necessitant une approbation manuelle sont creees :

1. Mise a jour du statut de la demande d'acces du demandeur
1. Mise a jour du statut de la demande d'acces de l'approbateur
1. Echec de la demande d'acces JITNA

:::info
Les evenements ne sont pas emis pour les demandes d'acces qui sont automatiquement approuvees en fonction de votre politique d'approbation automatique.
:::

## Details des evenements d'exemple

### Evenement de demande d'acces du demandeur

Voici un exemple des details de l'evenement `Requester Access Request Status Update`.
...
<Tabs
    ...
    values={[
        {label: 'En attente d\'approbation', value: 'pending'},
...
### Evenement de demande d'acces de l'approbateur

Voici un exemple des details de l'evenement `Approver Access Request Status Update`.
...
### Echec de la demande d'acces JITNA
...
### Exemple de details OpsItem

Les demandes d'acces juste-a-temps aux noeuds sont stockees en tant que [ressource OpsItem Systems Manager](https://docs.aws.amazon.com/systems-manager/latest/APIReference/API_OpsItem.html). Voici un exemple des details d'un OpsItem pour une demande d'acces de session qui a ete automatiquement approuvee par une politique d'approbation automatique.
...
## Modeles de regles EventBridge

<Tabs
    defaultValue="requester"
    values={[
        {label: 'Evenement du demandeur', value: 'requester'},
        {label: 'Evenement de l\'approbateur', value: 'approver'},
        {label: 'Evenement d\'echec', value: 'failed'},
    ]}>
