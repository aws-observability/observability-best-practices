...
- **[CloudWatch एनोमली डिटेक्शन](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch_Anomaly_Detection.html)** -- मेट्रिक्स का निरंतर एनालिसिस करने और विसंगतियों की पहचान करने के लिए ML एल्गोरिदम लागू करता है
