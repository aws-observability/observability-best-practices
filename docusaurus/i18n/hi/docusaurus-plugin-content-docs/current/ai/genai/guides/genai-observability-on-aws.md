...
यह गाइड AWS पर GenAI वर्कलोड की निगरानी के लिए नीति, AWS कार्यान्वयन, enablement patterns, और dashboard design के बारे में बताता है। यह साथी गाइड [GenAI टेलीमेट्री के लिए कस्टम डैशबोर्ड बनाना](../custom-dashboards-for-genai-telemetry) के साथ जोड़ा गया है, जो दिखाता है कि उसी टेलीमेट्री को DevOps, FinOps, और अन्य stakeholders के लिए persona-based डैशबोर्ड में कैसे बदलें।
...
1. **जल्दी instrument करें** -- ship करने के बाद नहीं, build करते समय ऑब्ज़र्वेबिलिटी जोड़ें। OpenTelemetry का उपयोग करें ताकि आपकी instrumentation vendor-neutral और portable रहे।
...
Amazon CloudWatch दो पूरक data pipelines के माध्यम से GenAI के लिए end-to-end ऑब्ज़र्वेबिलिटी प्रदान करता है। ये अलग-अलग उद्देश्यों की पूर्ति करती हैं, अलग-अलग data capture करती हैं, और अलग-अलग तरीके से enable की जाती हैं। अधिकांश production setups को दोनों की आवश्यकता होती है।
...
| Non-AgentCore (EKS/ECS/self-hosted) | ADOT ऑटो-इंस्ट्रुमेंटेशन agent attach करें। कोई code changes आवश्यक नहीं। |
...
**सारांश:** Agent Telemetry आपको बताती है *आपका agent कैसा प्रदर्शन कर रहा है*। Model Invocation Logging आपको बताता है *आपका model क्या कह रहा है और कौन पूछ रहा है*। पूर्ण ऑब्ज़र्वेबिलिटी के लिए, दोनों enable करें।

---

## Agentic Workloads के लिए ऑब्ज़र्वेबिलिटी Enable करना

शुरू करने से पहले, पूर्ण GenAI ऑब्ज़र्वेबिलिटी अनुभव unlock करने के लिए [CloudWatch Transaction Search](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/Enable-TransactionSearch.html) enable करें।
...
ऑब्ज़र्वेबिलिटी built-in है -- ADOT SDK AgentCore runtime में baked है। Metrics स्वचालित रूप से generate होती हैं, और traces बिना किसी code changes के flow होते हैं।

- [Custom ऑब्ज़र्वेबिलिटी configure करें](https://docs.aws.amazon.com/bedrock-agentcore/latest/devguide/observability-configure.html#observability-configure-custom)
- [Step-by-step tutorial: AgentCore Runtime hosted agents के लिए ऑब्ज़र्वेबिलिटी enable करना](https://aws.github.io/bedrock-agentcore-starter-toolkit/user-guide/observability/quickstart.html#enabling-observability-for-agentcore-runtime-hosted-agents)

### Non-AgentCore hosted agents (EKS, ECS, self-hosted)

आप AgentCore के बाहर अपने agents host कर सकते हैं और end-to-end monitoring के लिए अपना ऑब्ज़र्वेबिलिटी data CloudWatch में ला सकते हैं। अपने workload में ADOT ऑटो-इंस्ट्रुमेंटेशन agent attach करें -- कोई code changes आवश्यक नहीं।

- [Third-party ऑब्ज़र्वेबिलिटी configure करें](https://docs.aws.amazon.com/bedrock-agentcore/latest/devguide/observability-configure.html#observability-configure-3p)
- [Step-by-step tutorial: Non-AgentCore hosted agents के लिए ऑब्ज़र्वेबिलिटी enable करना](https://aws.github.io/bedrock-agentcore-starter-toolkit/user-guide/observability/quickstart.html#enabling-observability-for-non-agentcore-hosted-agents)

### AgentCore memory, gateway, और built-in tool resources

AgentCore modular services की metrics और traces में visibility प्राप्त करें। [CloudWatch ऑब्ज़र्वेबिलिटी configure करें](https://docs.aws.amazon.com/bedrock-agentcore/latest/devguide/observability-configure.html#observability-configure-cloudwatch) देखें।
...
| --- | --- | --- |
| Metrics | स्वचालित | ADOT ऑटो-इंस्ट्रुमेंटेशन agent |
| Agent traces और spans | स्वचालित (ADOT built-in) | ADOT ऑटो-इंस्ट्रुमेंटेशन agent |
| Model Invocation Logging | Bedrock console से manual opt-in | Bedrock console से manual opt-in |

दोनों paths में वास्तव में manual opt-in की आवश्यकता केवल Model Invocation Logging के लिए है। बाकी सब या तो automatic है या ADOT ऑटो-इंस्ट्रुमेंटेशन agent attach करके handle होता है।
...
- एनोमली डिटेक्शन के साथ daily cost trend
...
## ऑब्ज़र्वेबिलिटी Maturity Model
...
**Level 4: AI-Powered ऑब्ज़र्वेबिलिटी**

- Cost और behavior पर एनोमली डिटेक्शन
- Automated रूट कॉज़ एनालिसिस
...
ऑब्ज़र्वेबिलिटी केवल production नहीं, बल्कि पूरे ML lifecycle में extend होनी चाहिए:
...
- ऑब्ज़र्वेबिलिटी signals पर आधारित rollback triggers
...
- [ ] Non-AgentCore के लिए: ADOT ऑटो-इंस्ट्रुमेंटेशन agent attach करें
...
- [Model Invocations — CloudWatch GenAI ऑब्ज़र्वेबिलिटी](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/model-invocations.html)
...
- [Configure Custom ऑब्ज़र्वेबिलिटी for AgentCore](https://docs.aws.amazon.com/bedrock-agentcore/latest/devguide/observability-configure.html#observability-configure-custom)
- [Configure Third-Party ऑब्ज़र्वेबिलिटी](https://docs.aws.amazon.com/bedrock-agentcore/latest/devguide/observability-configure.html#observability-configure-3p)
