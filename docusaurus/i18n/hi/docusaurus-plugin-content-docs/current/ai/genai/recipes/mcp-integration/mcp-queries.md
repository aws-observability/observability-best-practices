...
1. **लागत विश्लेषण** (सबसे प्रभावशाली):
   ```
...
2. **मॉडल तुलना** (सबसे व्यापक):
   ...
   ```
   प्रोवाइडर्स में एकीकृत observability की शक्ति दिखाता है।
...
**समाधान**:
1. चेक करें कि MCP सर्वर चल रहा है: Kiro MCP पैनल में "ai-observability" देखें
