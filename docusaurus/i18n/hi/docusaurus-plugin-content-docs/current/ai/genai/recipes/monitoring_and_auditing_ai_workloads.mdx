---
sidebar_position: 3
description: "CloudTrail, Bedrock Model Invocation Logging और ADOT का उपयोग करके AWS पर AI वर्कलोड की मॉनिटरिंग और ऑडिटिंग की पूर्ण गाइड।"
...
1. **तीनों टेलीमेट्री पाइपलाइनों को सक्षम करना** — इस गाइड में संक्षिप्त सेटअप के साथ companion guides के deep links।
2. **CloudTrail पर detection rules बनाना** — Bedrock और AgentCore data events दोनों को कवर करते हुए metric filters, alarms और Contributor Insights rules।
3. **Cross-pipeline correlation queries चलाना** — CloudTrail को Bedrock Model Invocation Logging और ADOT spans के साथ join करना ताकि उन सवालों का जवाब दिया जा सके जो कोई एकल पाइपलाइन अकेले नहीं दे सकती।
...
- तीन टेलीमेट्री पाइपलाइन और प्रत्येक क्या uniquely कैप्चर करती है
