...
AWS Control Tower उन ऑर्गनाइज़ेशन्स की मदद करता है जिनके पास कई AWS अकाउंट और टीमें हैं जिन्हें अनुपालन सुनिश्चित करते हुए बड़े पैमाने पर अपने [मल्टी-अकाउंट AWS एनवायरनमेंट](https://docs.aws.amazon.com/whitepapers/latest/organizing-your-aws-environment/organizing-your-aws-environment.html) को सेट अप और गवर्न करने का एक सीधा तरीका चाहिए।
...
AWS Control Tower और Landing Zone Accelerator (LZA) पूरक समाधानों के रूप में अच्छी तरह से एक साथ काम करते हैं। अनुशंसित बेस्ट प्रैक्टिस यह है कि पहले AWS Control Tower को अपने मूलभूत landing zone के रूप में डिप्लॉय करें, और फिर आवश्यकतानुसार इसकी क्षमताओं को LZA के साथ बढ़ाएं।
