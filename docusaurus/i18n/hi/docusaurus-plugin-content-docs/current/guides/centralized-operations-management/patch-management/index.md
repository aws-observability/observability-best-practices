...
[Patch Manager](https://docs.aws.amazon.com/systems-manager/latest/userguide/systems-manager-patch.html), Systems Manager की एक क्षमता, आपको सुरक्षा-संबंधित अपडेट के साथ managed nodes की पैचिंग प्रक्रिया को ऑटोमेट करने की अनुमति देता है। आप Amazon EC2 instances, edge devices, और ऑन-प्रिमाइसेस सर्वर और virtual machines (VMs) को पैच कर सकते हैं, जिसमें अन्य cloud environments में VMs भी शामिल हैं।

## पैचिंग को कठिन क्या बनाता है?
