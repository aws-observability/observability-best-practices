...
आपके नोड बुनियादी ढाँचे में सुरक्षा और प्रदर्शन बनाए रखने के लिए एक मजबूत पैच प्रबंधन रणनीति की आवश्यकता होती है। यह निर्देशित समाधान आपको [AWS Systems Manager](https://aws.amazon.com/systems-manager/) का उपयोग करके एक स्वचालित, tag-आधारित पैच प्रबंधन प्रणाली लागू करने के माध्यम से चलेगा। इस निर्देशित समाधान का पालन करके, आप एक स्केलेबल और कुशल पैचिंग प्रक्रिया स्थापित करेंगे जो सुरक्षा अनुपालन में सुधार करते हुए मैनुअल हस्तक्षेप को कम करती है। इस विधि का उपयोग [AWS Organizations](https://aws.amazon.com/organizations/) के भीतर एक केंद्रीकृत दृष्टिकोण के लिए किया जा सकता है, और इसे एकल खातों के लिए भी लागू किया जा सकता है।
