...
अपने activity logs (management और data events) का एनालिसिस शुरू करने में मदद करने के लिए Natural Language query processor का उपयोग करें जो CloudTrail Lake में संग्रहीत हैं बिना SQL query लिखे या अपने activity events को क्वेरी करने के लिए आवश्यक SQL syntax को समझने में समय बिताए। NLQ आपको यह पूछकर आपके डेटा में तेज़ अंतर्दृष्टि प्राप्त करने में भी सहायक हो सकता है कि आप क्या क्वेरी करना चाहते हैं और फिर यह उपयोग करने के लिए SQL query प्रदान करता है।
