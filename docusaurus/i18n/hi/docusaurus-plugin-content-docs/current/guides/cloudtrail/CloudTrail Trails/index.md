...
AWS CloudTrail आपके AWS बुनियादी ढाँचे में खाता गतिविधि की निगरानी और रिकॉर्ड करता है ताकि आपको स्टोरेज, एनालिसिस और उपचारात्मक कार्रवाइयों पर नियंत्रण प्रदान किया जा सके। एक trail एक कॉन्फ़िगरेशन है जो CloudTrail events को आपके द्वारा निर्दिष्ट Amazon Simple Storage Service (Amazon S3) bucket में वितरित करने में मदद करता है।
...
अंत में, organizational trail है जो AWS Organizations सेवा का उपयोग करते समय आपके ऑर्गनाइज़ेशन के भीतर सभी AWS accounts पर लागू होता है। इस प्रकार का trail मल्टी-अकाउंट एनवायरनमेंट में व्यापक कवरेज और केंद्रीकृत निगरानी प्रदान करता है।

इन trail प्रकारों का उपयोग करके, आप अपनी निगरानी और रिकॉर्डिंग आवश्यकताओं को पूरा करने के लिए अपने CloudTrail सेटअप को अनुकूलित कर सकते हैं। आप यह Regional स्तर पर या अपने संपूर्ण ऑर्गनाइज़ेशन में कर सकते हैं। निम्नलिखित CloudTrail Trails के लिए कुछ बेस्ट प्रैक्टिसएँ हैं।

### सभी AWS accounts और Regions में CloudTrail कॉन्फ़िगर करें

AWS accounts में किसी उपयोगकर्ता, role, या सेवा द्वारा की गई events का पूर्ण रिकॉर्ड प्राप्त करने के लिए, प्रत्येक trail को सभी AWS Regions में events लॉग करने के लिए कॉन्फ़िगर करें। इन trails को अपनी कंपनी या ऑर्गनाइज़ेशन द्वारा उपयोग किए जाने वाले प्रत्येक AWS account में सेट करें। यह सेटअप सुनिश्चित करता है कि प्रत्येक event लॉग की जाती है, चाहे event किसी भी AWS Region में हुई हो। परिणामस्वरूप, आप अन्यथा अप्रयुक्त Regions में अप्रत्याशित गतिविधि का पता लगा सकते हैं। Global service events (उदाहरण के लिए, AWS Identity and Access Management और Amazon Route 53) भी शामिल और लॉग किए जाते हैं। यदि आप एक trail बनाते हैं जो सभी Regions पर लागू होता है, तो कोई भी नया AWS Region स्वचालित रूप से शामिल हो जाता है। यदि आपके पास AWS Organizations के माध्यम से मल्टी-अकाउंट सेटअप है, तो आप एक trail बना सकते हैं जो उस ऑर्गनाइज़ेशन में सभी AWS accounts के लिए सभी events लॉग करता है।
...
*   यह policy आपके AWS account में IAM identities के लिए व्यापक रूप से साझा या लागू करने के लिए अभिप्रेत नहीं है। इस policy के एप्लिकेशन को उन व्यक्तियों तक सीमित करें जिनसे आप AWS account administrators के रूप में कार्य करने की अपेक्षा करते हैं।
