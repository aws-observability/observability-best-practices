---
sidebar_position: 1
title: Amazon Athena का उपयोग करके CloudTrail Log प्रबंधन का स्वचालन
description: अनुकूलित प्रदर्शन, लागत में कमी और बेहतर सुरक्षा जाँच के लिए partitioned Athena tables का उपयोग करके AWS CloudTrail log विश्लेषण को स्वचालित करने की मार्गदर्शिका।
---

# Amazon Athena का उपयोग करके CloudTrail Log प्रबंधन का स्वचालन
