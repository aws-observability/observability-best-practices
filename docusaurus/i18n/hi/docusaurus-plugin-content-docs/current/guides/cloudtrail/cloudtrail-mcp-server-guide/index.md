...
सुरक्षा, अनुपालन और संचालन टीमें AWS अकाउंट एक्टिविटी को समझने के लिए CloudTrail लॉग्स का विश्लेषण करने में महत्वपूर्ण समय व्यतीत करती हैं:
...
- **अनुपालन टीमों** को यह दिखाने वाली ऑडिट रिपोर्ट्स जनरेट करनी होती हैं कि किसने किन रिसोर्सेज को एक्सेस किया, परिवर्तन कब किए गए, और गतिविधियाँ संगठनात्मक नीतियों के अनुरूप हैं या नहीं
...
- मल्टी-अकाउंट सपोर्ट
- समय-आधारित विश्लेषण और इवेंट सहसंबंध
...
**यह क्या करता है:** [CloudTrail event records](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/cloudtrail-event-reference-record-contents.html) का विश्लेषण करके संभावित ब्रूट फ़ोर्स हमलों या समझौता किए गए क्रेडेंशियल्स की पहचान करता है
...
**यह क्या करता है:** पूरे संगठन में MFA अनुपालन को मान्य करता है
...
**यह क्या करता है:** पूरे AWS संगठन में सुरक्षा जोखिमों की पहचान करता है

**उपयोग मामला:** सुरक्षा टीम संगठन-व्यापी सुरक्षा स्थिति समीक्षा करती है
...
**यह क्या करता है:** पूरे संगठन में ऑडिट लॉगिंग अनुपालन को मान्य करता है
