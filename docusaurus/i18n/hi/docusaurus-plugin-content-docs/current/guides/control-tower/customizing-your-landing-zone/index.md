...
Control Tower एक अच्छी तरह से गवर्न किए गए लैंडिंग ज़ोन के लिए एक शुरुआती बिंदु परिभाषित करता है, लेकिन अधिकांश ग्राहकों को अपने वर्कलोड के लिए अतिरिक्त platform services लागू करने की आवश्यकता होती है। इसमें केंद्रीकृत नेटवर्किंग, सुरक्षा सेवाएं, केंद्रीकृत Observability सेवाएं आदि शामिल हो सकती हैं।
