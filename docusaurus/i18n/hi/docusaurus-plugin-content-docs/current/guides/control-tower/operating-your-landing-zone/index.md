...
किसी भी अपडेट के प्रभाव का परीक्षण करने के लिए पहले non-prod OUs को re-register करके गैर-प्रोडक्शन वर्कलोड को प्रोडक्शन वर्कलोड से अलग OU में रखना एक सर्वोत्तम प्रथा है।


## Drift प्रबंधित करें

Drift तब होता है जब आपके AWS Control Tower लैंडिंग ज़ोन components, accounts, या organizational units (OUs) परिभाषित baselines और controls के साथ sync से बाहर हो जाते हैं। आपके AWS वातावरण में governance और compliance बनाए रखने के लिए drift को समझना और प्रबंधित करना महत्वपूर्ण है।
...
[Controls लागू करने के लिए सर्वोत्तम प्रथाओं](https://aws.amazon.com/blogs/mt/best-practices-for-applying-controls-with-aws-control-tower/) का पालन करें।
