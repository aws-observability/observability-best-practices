# AWS ऑब्ज़र्वेबिलिटी सेवाएं और लागत

जैसे-जैसे आप अपने ऑब्ज़र्वेबिलिटी स्टैक में निवेश करते हैं, यह महत्वपूर्ण है कि आप नियमित आधार पर अपने ऑब्ज़र्वेबिलिटी उत्पादों की **लागत** की निगरानी करें। इससे आप यह सुनिश्चित कर सकते हैं कि आप केवल आवश्यक लागत वहन कर रहे हैं और उन resources पर अधिक खर्च नहीं कर रहे जिनकी आपको आवश्यकता नहीं है।

## लागत ऑप्टिमाइज़ेशन के लिए AWS टूल

अधिकांश ऑर्गनाइज़ेशन्स का मुख्य ध्यान क्लाउड पर अपने IT infrastructure को scale करने पर होता है, और आमतौर पर वे अपने वास्तविक या आगामी cloud खर्च के बारे में अनियंत्रित, अप्रस्तुत और अनजान होते हैं। समय के साथ लागत को ट्रैक, रिपोर्ट और विश्लेषित करने में मदद के लिए, AWS कई लागत-ऑप्टिमाइज़ेशन टूल प्रदान करता है:
...
[AWS Cost and Usage Report(CUR)][CUR] – accounts में आपके hourly AWS उपयोग का विवरण देने वाली granular raw data files जो Do-It-Yourself (DIY) एनालिसिस के लिए उपयोग की जाती हैं। AWS Cost and Usage Report में dynamic columns हैं जो आपके द्वारा उपयोग की जाने वाली services के आधार पर populate होते हैं।
...
[Cloud Intelligence Dashboards][cid] AWS Cost and Usage report (CUR) पर निर्मित [Amazon QuickSight][quicksight] डैशबोर्ड का एक संग्रह है। ये डैशबोर्ड आपके अपने cost management और optimization (FinOps) टूल के रूप में काम करते हैं। आपको गहन, granular, और recommendation-driven डैशबोर्ड मिलते हैं जो आपको आपके AWS उपयोग और लागत का विस्तृत दृश्य प्राप्त करने में मदद कर सकते हैं।
