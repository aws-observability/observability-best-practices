...
आमतौर पर `GetMetricData` तृतीय-पक्ष Observability टूल्स और/या cloud financial टूल्स द्वारा अपने platform में CloudWatch Metrics का उपयोग करने से होने वाली calls के कारण होता है। 
