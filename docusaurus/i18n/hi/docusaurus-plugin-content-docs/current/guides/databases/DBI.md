...
|---|:---:|:---:|
| Dimension द्वारा शीर्ष DB Load contributors का विश्लेषण | ✔ | ✔ |
...
- Cross-account monitoring के लिए monitoring और source दोनों accounts में CloudWatch Observability Access Manager (OAM) setup आवश्यक है।
...
### Standard से शुरू करें, रणनीतिक रूप से Upgrade करें
...
Slow SQL analysis और Database Telemetry का Logs section तभी काम करता है जब आपने CloudWatch Logs में log export सक्षम किया हो। इसे instance creation time पर करें बजाय retroactively के — आप export सक्षम होने से पहले की historical slow queries का विश्लेषण नहीं कर सकते।
...
यदि आपका organization विभिन्न services या environments के लिए अलग AWS accounts का उपयोग करता है, तो OAM के साथ CloudWatch cross-account observability सेट अप करें। इससे एक central monitoring account सभी accounts और regions में Fleet Health Dashboard देख सकता है — shared database infrastructure प्रबंधित करने वाली platform teams के लिए आवश्यक।
