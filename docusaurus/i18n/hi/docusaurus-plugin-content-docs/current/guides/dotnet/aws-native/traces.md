...
इस अनुभाग में, आप AWS डॉक्यूमेंटेशन और ओपन सोर्स रिपॉज़िटरी के लिंक देखेंगे जो AWS X-Ray SDK for .NET का उपयोग करके .NET एप्लिकेशन्स को इंस्ट्रूमेंट करने और X-Ray daemon के माध्यम से AWS X-Ray को ट्रेस जानकारी बनाने और भेजने के बारे में जानकारी प्रदान करेंगे।
...
X-Ray SDK for .NET, C# .NET वेब एप्लिकेशन्स, .NET Core वेब एप्लिकेशन्स और AWS Lambda पर .NET Core फ़ंक्शंस को इंस्ट्रूमेंट करने के लिए एक लाइब्रेरी है। यह X-Ray daemon को ट्रेस डेटा जनरेट करने और भेजने के लिए classes और methods प्रदान करती है। इसमें एप्लिकेशन द्वारा सर्व किए गए इनकमिंग अनुरोधों और एप्लिकेशन द्वारा डाउनस्ट्रीम AWS सेवाओं, HTTP वेब APIs और SQL डेटाबेस को किए गए कॉल के बारे में जानकारी शामिल है।
...
अपने ASP.NET और ASP.NET Core एप्लिकेशन्स में X-Ray SDK for .NET का उपयोग सीखने के लिए नमूना एप्लिकेशन नीचे लिंक किए गए हैं

[**नमूना ASP.NET और ASP.NET Core एप्लिकेशन**](https://github.com/aws-samples/aws-xray-dotnet-webapp)