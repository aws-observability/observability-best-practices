...
अब जब आपका एप्लिकेशन इंस्ट्रूमेंट हो गया है, तो एक collector agent का उपयोग करें—जैसे OpenTelemetry Collector, CloudWatch Agent, या Fluent Bit—अपनी पसंद के ऑब्ज़र्वेबिलिटी backend पर लॉग्स रूट करने के लिए। विवरण और कार्यान्वयन मार्गदर्शन के लिए नीचे दिए गए लिंक देखें।
