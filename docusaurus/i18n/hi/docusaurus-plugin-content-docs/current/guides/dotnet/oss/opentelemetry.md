...
1. **Exporter** पैकेज विभिन्न ऑब्ज़र्वेबिलिटी प्लेटफ़ॉर्म के लिए bridges के रूप में कार्य करते हैं, जो आपको अपने एकत्रित टेलीमेट्री डेटा को Jaeger, Prometheus, या OTLP प्रोटोकॉल का समर्थन करने वाली किसी भी प्रणाली जैसे विभिन्न गंतव्यों पर भेजने की अनुमति देते हैं।

ये कंपोनेंट NuGet के माध्यम से उपलब्ध एक समेकित प्रणाली के रूप में एक साथ काम करते हैं, .NET एप्लिकेशन्स के लिए एक संपूर्ण ऑब्ज़र्वेबिलिटी समाधान प्रदान करते हैं।
...
| [OpenTelemetry.Extensions.AWS](https://github.com/open-telemetry/opentelemetry-dotnet-contrib/tree/main/src/OpenTelemetry.Extensions.AWS)    | AWS X-Ray के माध्यम से Trace Context propagation का समर्थन करता है। |