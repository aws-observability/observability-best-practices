# Java Spring Integration एप्लिकेशन्स को इंस्ट्रूमेंट करना

यह लेख [Open Telemetry](https://opentelemetry.io/) और [X-ray](https://aws.amazon.com/xray/) का उपयोग करके [Spring-Integration](https://docs.spring.io/spring-integration/reference/overview.html) एप्लिकेशन्स को मैन्युअल रूप से इंस्ट्रूमेंट करने के दृष्टिकोण का वर्णन करता है।

Spring-Integration फ्रेमवर्क event-driven आर्किटेक्चर और messaging-centric आर्किटेक्चर के लिए विशिष्ट एकीकरण समाधानों के विकास को सक्षम करने के लिए डिज़ाइन किया गया है। दूसरी ओर, OpenTelemetry माइक्रोसर्विसेज आर्किटेक्चर पर अधिक केंद्रित है, जिसमें सेवाएं HTTP अनुरोधों का उपयोग करके एक-दूसरे के साथ संवाद और समन्वय करती हैं। इसलिए यह गाइड OpenTelemetry API के साथ manual instrumentation का उपयोग करके Spring-Integration एप्लिकेशन्स को इंस्ट्रूमेंट करने का एक उदाहरण प्रदान करेगा।
...
:::note
    ट्रेसेस हमें यह बड़ी तस्वीर देते हैं कि जब किसी एप्लिकेशन को अनुरोध किया जाता है तो क्या होता है। चाहे आपका एप्लिकेशन एक डेटाबेस वाला monolith हो या सेवाओं का एक परिष्कृत mesh, ट्रेसेस यह समझने के लिए आवश्यक हैं कि एक अनुरोध आपके एप्लिकेशन में पूर्ण "पथ" कैसे लेता है।
:::
