...
इस विषय पर गहन अनुभव प्राप्त करने के लिए हमारे [One ऑब्ज़र्वेबिलिटी Workshop के EC2 केंद्रित मॉड्यूल](https://catalog.workshops.aws/observability/en-US/aws-managed-oss/ec2-monitoring) को देखें।
...
यह देखते हुए कि किसी भी एनवायरनमेंट में संसाधन (CPU, Memory) सीमित हैं, आपको अप्रत्याशित स्थितियों के कारण विफलताओं से बचने के लिए collector components पर सीमाएं निर्धारित करनी चाहिए।
