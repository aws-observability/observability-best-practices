...
अलर्टिंग मजबूत मॉनिटरिंग और ऑब्ज़र्वेबिलिटी बेस्ट प्रैक्टिसेज़ का एक प्रमुख पहलू है। अलर्टिंग तंत्र को alert fatigue और महत्वपूर्ण अलर्ट चूकने के बीच संतुलन बनाना चाहिए। यहां कुछ अलर्ट हैं जो वर्कलोड की समग्र विश्वसनीयता में सुधार के लिए अनुशंसित हैं। ऑर्गनाइज़ेशन में विभिन्न टीमें विभिन्न दृष्टिकोणों से अपने इंफ्रास्ट्रक्चर और वर्कलोड की निगरानी करती हैं और इसलिए इसे आवश्यकता और परिदृश्य के आधार पर विस्तारित या बदला जा सकता है और निश्चित रूप से यह एक व्यापक सूची नहीं है।
...
अधिक जानकारी के लिए ग्राहक [AWS डॉक्यूमेंटेशन](https://docs.aws.amazon.com/prometheus/latest/userguide/AMP-alert-manager.html) पढ़ सकते हैं, Amazon Managed Service for Prometheus Alert Manager पर [AWS ऑब्ज़र्वेबिलिटी Workshop](https://catalog.workshops.aws/observability/en-US/aws-managed-oss/amp/setup-alert-manager) से गुजर सकते हैं।
