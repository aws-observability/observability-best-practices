...
कृपया हमारे One ऑब्ज़र्वेबिलिटी Workshop मॉड्यूल - [GitOps with Amazon Managed Grafana](https://catalog.workshops.aws/observability/en-US/aws-managed-oss/gitops-with-amg) देखें। यह मॉड्यूल आपके EKS cluster पर निम्नलिखित जैसे आवश्यक "Day 2" operational tooling सेटअप करता है:
