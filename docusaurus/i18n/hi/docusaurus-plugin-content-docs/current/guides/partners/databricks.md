...
## AWS Native ऑब्ज़र्वेबिलिटी विकल्प
...
## Open-source software ऑब्ज़र्वेबिलिटी विकल्प
...
![Databricks OpenSource ऑब्ज़र्वेबिलिटी Diagram](../../images/databricks_oss_diagram.png)
*चित्र 3: Databricks Open Source ऑब्ज़र्वेबिलिटी Architecture*

AWS Managed Open Source Services for ऑब्ज़र्वेबिलिटी का उपयोग करके Databricks cluster से metrics observe करने के लिए, आपको metrics और alerts दोनों visualize करने के लिए एक Amazon Managed Grafana workspace और Amazon Managed Grafana workspace में datasource के रूप में कॉन्फ़िगर किया गया एक Amazon Managed Service for Prometheus workspace चाहिए।
