...
<!--: Enhancing ऑब्ज़र्वेबिलिटी for Applications Running on Instances-->
...
2. **प्रदर्शन एनालिसिस**: X-Ray आपके EC2-होस्टेड एप्लिकेशन के लिए विस्तृत प्रदर्शन मेट्रिक्स जैसे रिक्वेस्ट लेटेंसी, एरर रेट और रिसोर्स उपयोग एकत्र करता है। ये मेट्रिक्स आपको अपने एप्लिकेशन के प्रदर्शन का एनालिसिस करने, प्रदर्शन हॉटस्पॉट की पहचान करने और रिसोर्स आवंटन अनुकूलित करने की अनुमति देती हैं।
...
अपने EC2-होस्टेड एप्लिकेशन की बढ़ी हुई ऑब्ज़र्वेबिलिटी के लिए AWS X-Ray का लाभ उठाने के लिए, आपको इन सामान्य चरणों का पालन करना होगा:
...
3. **ट्रेस डेटा एनालिसिस करें**: ट्रेस डेटा का एनालिसिस करने, सर्विस मैप देखने, और अपने EC2-होस्टेड एप्लिकेशन के भीतर प्रदर्शन समस्याओं या बाधाओं की जांच करने के लिए AWS X-Ray कंसोल या APIs का उपयोग करें।
...
5. **अन्य ऑब्ज़र्वेबिलिटी टूल्स के साथ एकीकृत करें**: अपने एप्लिकेशन के प्रदर्शन, लॉग्स और मेट्रिक्स का व्यापक दृश्य प्राप्त करने के लिए AWS X-Ray को अन्य ऑब्ज़र्वेबिलिटी टूल्स जैसे AWS CloudWatch Logs, Amazon CloudWatch Metrics, और AWS Distro for OpenTelemetry के साथ संयोजित करें।
