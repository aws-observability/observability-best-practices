...
मॉनिटरिंग आर्किटेक्चर एक ECS task के चारों ओर केंद्रित है जो एप्लिकेशन और ADOT collector दोनों को होस्ट करता है। यह सेटअप सीधे एप्लिकेशन वातावरण से व्यापक डेटा संग्रह को सक्षम बनाता है।
...
3. ट्रेस डेटा वितरित ट्रेसिंग विश्लेषण के लिए AWS X-Ray को अग्रेषित किया जाता है।
4. मेट्रिक्स स्टोरेज और बाद के विश्लेषण के लिए Amazon Managed Service for Prometheus को भेजी जाती हैं।
