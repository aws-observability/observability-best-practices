...
# JITNA के साथ EventBridge इंटीग्रेशन

Just-in-time node access (JITNA) का उपयोग करते समय, जब manual approval की आवश्यकता वाले session access request बनाए जाते हैं तो [EventBridge](https://aws.amazon.com/eventbridge/) को तीन प्रकार के इवेंट भेजे जाते हैं:
...
:::info
आपकी auto-approval policy के आधार पर स्वचालित रूप से अनुमोदित access requests के लिए इवेंट नहीं भेजे जाते हैं।
:::

## उदाहरण इवेंट विवरण

### Requester access request इवेंट

नीचे `Requester Access Request Status Update` इवेंट के लिए इवेंट विवरण का एक उदाहरण है।
...
### Approver access request इवेंट

नीचे `Approver Access Request Status Update` इवेंट के लिए इवेंट विवरण का एक उदाहरण है।
...
### उदाहरण OpsItem विवरण

Just-in-time node access requests एक [Systems Manager OpsItem resource](https://docs.aws.amazon.com/systems-manager/latest/APIReference/API_OpsItem.html) के रूप में संग्रहीत किए जाते हैं। नीचे एक OpsItem के विवरण का एक उदाहरण है जो एक session access request के लिए है जिसे auto-approval policy द्वारा स्वचालित रूप से अनुमोदित किया गया था।
