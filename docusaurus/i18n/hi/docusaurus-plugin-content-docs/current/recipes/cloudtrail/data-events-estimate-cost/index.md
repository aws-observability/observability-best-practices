...
- **ऐतिहासिक विश्लेषण**: CUR डेटा भविष्य की लागतों का अनुमान लगाने के लिए बिलिंग योग्य ऑपरेशंस के ऐतिहासिक उपयोग पैटर्न प्रदान करता है
- **विस्तृत दृश्यता**: आप ट्रैक किए गए ऑपरेशंस के लिए अकाउंट, बकेट, ऑपरेशन प्रकार और समय अवधि के अनुसार लागतों का विश्लेषण कर सकते हैं
...
निम्नलिखित क्वेरी CloudTrail Data Events लागत का अनुमान लगाने के लिए CUR डेटा से [S3 के लिए CloudTrail Data Events](https://docs.aws.amazon.com/AmazonS3/latest/userguide/cloudtrail-logging-s3-info.html#cloudtrail-data-events) से जुड़े आपके Amazon S3 API ऑपरेशंस का विश्लेषण करती है।
