...
[Amazon CloudWatch][cw-main] (CW) DevOps इंजीनियरों, डेवलपर्स, साइट रिलायबिलिटी इंजीनियरों (SRE) और IT मैनेजरों के लिए बनाई गई एक मॉनिटरिंग और ऑब्ज़र्वेबिलिटी सेवा है।
...
- [EKS में Kubernetes-नेटिव डेवलपर्स के लिए CloudWatch-केंद्रित ऑब्ज़र्वेबिलिटी लागू करना][swa-eks-cw]
...
- [CloudWatch के माध्यम से एनोमली डिटेक्शन][cw-am]
...
[swa-eks-cw]: https://aws.amazon.com/blogs/opensource/implementing-cloudwatch-centric-ऑब्ज़र्वेबिलिटी-for-kubernetes-native-developers-in-amazon-elastic-kubernetes-service/
[cw-synths]: https://ऑब्ज़र्वेबिलिटी.workshop.aws/en/synthetics.html
[cw-logsi]: https://ऑब्ज़र्वेबिलिटी.workshop.aws/en/logsinsights.html
[cw-lambda]: https://ऑब्ज़र्वेबिलिटी.workshop.aws/en/logsinsights.html
[cw-am]: https://ऑब्ज़र्वेबिलिटी.workshop.aws/en/anomalydetection.html
[cw-alarms]: https://ऑब्ज़र्वेबिलिटी.workshop.aws/en/alarms/_mericalarm.html
...
[cwci-ecs]: https://ऑब्ज़र्वेबिलिटी.workshop.aws/en/containerinsights/ecs.html
[cwci-eks]: https://ऑब्ज़र्वेबिलिटी.workshop.aws/en/containerinsights/eks.html
