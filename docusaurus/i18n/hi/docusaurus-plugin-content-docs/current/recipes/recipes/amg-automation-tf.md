...
* [AWS command line][aws-cli] आपके लोकल वातावरण में स्थापित और [कॉन्फ़िगर][aws-cli-conf] होनी चाहिए।
* आपके लोकल वातावरण में [Terraform][tf] कमांड लाइन स्थापित होनी चाहिए।
...
```
ऊपर की फ़ाइल में आपको अपने वातावरण के अनुसार तीन मान डालने होंगे।
...
Terraform ऑटोमेशन के लिए एक शक्तिशाली उपकरण है और आप इसे यहाँ दिखाए अनुसार अपने Grafana संसाधनों का प्रबंधन करने के लिए उपयोग कर सकते हैं।
