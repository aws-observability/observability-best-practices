...
Cloud9 वातावरण से 'dashboard_out' फ़ोल्डर की सामग्री डाउनलोड करें और Grafana वेब UI का उपयोग करके उन्हें अपलोड करें।
