# Fargate पर EKS में Amazon Managed Service for Prometheus के साथ AWS Distro for OpenTelemetry का उपयोग
...
सेट करना सुनिश्चित करें `<YOUR_REGION>` in your shell session, for example, in Bash:
...
EKS पर हमारे एप्लिकेशन को डिप्लॉय करने के लिए हमें एक कंटेनर repository.
अपने खाते में एक नई ECR रिपॉजिटरी बनाने के लिए आप निम्नलिखित कमांड का उपयोग कर सकते हैं।
...
Amazon Managed Service for Prometheus वर्कस्पेस हटाएं:
