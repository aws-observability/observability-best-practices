...
:::note
    इस गाइड को पूरा करने में लगभग 45 minutes लगेंगे।
:::
## इंफ्रास्ट्रक्चर
...
For more details on AMP देखें the [AMP Getting started](https://docs.aws.amazon.com/prometheus/latest/userguide/AMP-getting-started.html) guide.
