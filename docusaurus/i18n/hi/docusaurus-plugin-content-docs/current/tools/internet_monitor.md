...
:::
[अपने वर्कलोड की सभी परतों से टेलीमेट्री एकत्र करना](../guides/index.md#collect-telemetry-from-all-tiers-of-your-workload) एक बेस्ट प्रैक्टिस है, और यह एक चुनौती हो सकती है। लेकिन आपके वर्कलोड की परतें क्या हैं? कुछ के लिए यह वेब, एप्लिकेशन और डेटाबेस सर्वर हो सकती हैं। अन्य लोग अपने वर्कलोड को फ्रंट एंड और बैक एंड के रूप में देख सकते हैं। और वेब एप्लिकेशन संचालित करने वाले [Real User Monitoring](./rum.md)(RUM) का उपयोग करके इन ऐप्स की स्थिति का अवलोकन कर सकते हैं जैसा कि अंतिम उपयोगकर्ताओं द्वारा अनुभव किया जाता है।
...
Internet Monitor में ट्रैफिक ऑप्टिमाइज़ेशन सिफारिशों की सुविधा है जो आपको सलाह दे सकती है कि बेस्ट ग्राहक अनुभव प्राप्त करने के लिए अपने वर्कलोड कहां रखने चाहिए। उन वर्कलोड के लिए जो वैश्विक हैं, या जिनके वैश्विक ग्राहक हैं, यह सुविधा विशेष रूप से मूल्यवान है।
