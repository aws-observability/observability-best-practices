...
सर्वोत्तम अभ्यास गाइड के इस अनुभाग में हम कुछ अन्य प्रकार के लॉग के लिए उदाहरण क्वेरी प्रदान करते हैं जो वर्तमान में बिल्ट-इन उदाहरणों में शामिल नहीं हैं। यह सूची समय के साथ विकसित और बदलेगी और आप GitHub पर एक [issue](https://github.com/aws-observability/observability-best-practices/issues) छोड़कर समीक्षा के लिए अपने स्वयं के उदाहरण सबमिट कर सकते हैं।
