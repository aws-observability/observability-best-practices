# CloudWatch Logs के लिए सुरक्षा सर्वोत्तम अभ्यास
...
CloudWatch Logs आर्किटेक्चर को समझना प्रभावी सुरक्षा नियंत्रण लागू करने के लिए मौलिक है। उचित लॉग संगठन और पदानुक्रम डिज़ाइन सभी अन्य सुरक्षा उपायों की नींव बनाते हैं।
...
*   **लॉग स्ट्रीम**: एक लॉग ग्रुप के भीतर लॉग इवेंट के व्यक्तिगत अनुक्रम, आमतौर पर एक एकल स्रोत (जैसे EC2 इंस्टेंस, Lambda फंक्शन, या एप्लिकेशन प्रोसेस) का प्रतिनिधित्व करते हैं। लॉग स्ट्रीम अपने पैरेंट लॉग ग्रुप से सुरक्षा सेटिंग्स इनहेरिट करते हैं लेकिन विस्तृत एक्सेस कंट्रोल के लिए IAM नीतियों में व्यक्तिगत रूप से लक्षित किए जा सकते हैं
...
*   **वातावरण अलगाव**: विभिन्न एक्सेस कंट्रोल और रिटेंशन नीतियों को लागू करने के लिए प्रोडक्शन, स्टेजिंग, और डेवलपमेंट वातावरण के लिए अलग लॉग ग्रुप का उपयोग करें
...
*   IAM नीतियों का उपयोग करके नियंत्रित करें कि कौन लॉग ग्रुप और लॉग स्ट्रीम बना सकता है, पढ़ सकता है, और प्रबंधित कर सकता है ([Using identity-based policies for CloudWatch Logs](https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/iam-identity-based-access-control-cwl.html))
    - **न्यूनतम-विशेषाधिकार सिद्धांत लागू करें**: कस्टमर-मैनेज्ड नीतियां बनाएं जो आपकी संगठनात्मक आवश्यकताओं के आधार पर विशिष्ट लॉग ग्रुप तक एक्सेस प्रतिबंधित करें
...
-   संगठन स्तर पर Service Control Policies (SCP) लागू करें ([Service control policies](https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_policies_scps.html))
...
#### डेस्टिनेशन के लिए रिसोर्स-बेस्ड नीति सर्वोत्तम अभ्यास:
...
#### लॉग केंद्रीकरण सर्वोत्तम अभ्यास:
*   **संगठनात्मक संरचना स्थापित करें**: Log Archive अकाउंट को CloudWatch delegated administrator के रूप में नामित करें
