...
## KPI (重要業績評価指標) を把握し、測定しましょう！ {#know-your-key-performance-indicatorskpis-and-measure-them}
...
## 運用メトリクスデータとの相関関係 {#correlate-with-operational-metric-data}
...
## 正常な状態を把握しましょう！ {#know-what-good-looks-like}
...
:::info
パフォーマンスが要求される水準を下回るか上回った場合に[アラーム](./alarms.md)を作成できるよう、KPI には必ず正常な範囲を特定しておく*必要があります*。
:::
## 異常検出アルゴリズムを使用する
...
## 異常検知アルゴリズムを使用する {#use-anomaly-detection-algorithms}
