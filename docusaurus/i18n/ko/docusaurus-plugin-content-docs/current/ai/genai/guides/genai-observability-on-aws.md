...
이 가이드는 AWS에서 GenAI 워크로드를 모니터링하기 위한 전략, AWS 구현, 활성화 패턴, 대시보드 설계를 안내합니다. 이 가이드는 동일한 텔레메트리를 DevOps, FinOps 및 기타 이해관계자를 위한 페르소나 기반 대시보드로 전환하는 방법을 보여주는 [GenAI 텔레메트리를 위한 커스텀 대시보드 생성](../custom-dashboards-for-genai-telemetry.md) 가이드와 함께 사용됩니다.
...
두 파이프라인이 모두 흐르면 다양한 대상을 위한 대시보드를 구축할 수 있습니다. 바로 사용할 수 있는 쿼리는 [GenAI 텔레메트리를 위한 커스텀 대시보드 생성](../custom-dashboards-for-genai-telemetry.md) 가이드를 참조하세요.
...
전체 비용 계산 및 더 많은 예시는 [대시보드 쿼리 가이드](../custom-dashboards-for-genai-telemetry.md)를 참조하세요.
...
- [ ] [대시보드 쿼리 가이드](../custom-dashboards-for-genai-telemetry.md)를 사용하여 초기 대시보드 구축
...
- [GenAI 텔레메트리를 위한 커스텀 대시보드 생성](../custom-dashboards-for-genai-telemetry.md) — 텔레메트리를 DevOps, FinOps 및 기타 이해관계자를 위한 페르소나 기반 대시보드로 전환
