...
완전한 모범 사례 컬렉터 구성, ADOT 파이프라인 구성 및 Prometheus 스크래핑 구성은 [Observability Accelerator의 Helm Chart](https://github.com/aws-observability/terraform-aws-observability-accelerator)에서 찾을 수 있습니다.
