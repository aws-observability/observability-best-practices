...
AWS X-Ray 비용 및 사용량 시각화를 통해 개별 AWS 계정, AWS 리전, TracesStored의 비용에 대한 인사이트를 얻을 수 있습니다!  
...
2.	다음 쿼리를 사용하여 새 Amazon Athena [뷰][view]를 생성합니다. 이 쿼리는 Organization의 모든 AWS 계정에 걸친 AWS X-Ray의 비용과 사용량을 가져옵니다.
