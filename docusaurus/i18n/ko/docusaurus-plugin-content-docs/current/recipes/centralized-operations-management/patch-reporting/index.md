...
1. [조직 리소스 데이터 동기화용 샘플 CloudFormation 템플릿](https://github.com/aws-samples/cloud-operations-best-practices/blob/main/cloud-operations-best-practices/static/cfn-templates/patch-reporting/organization-resource-data-sync.yaml)을 로컬 머신에 다운로드합니다.
