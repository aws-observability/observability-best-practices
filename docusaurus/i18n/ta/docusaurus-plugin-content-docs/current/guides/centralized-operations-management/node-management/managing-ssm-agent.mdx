...
# AWS Organization-க்குள் SSM Agent நிர்வகித்தல்

இந்த பிரிவு AWS Organization-க்குள் SSM agent installation-ஐ எவ்வாறு நிர்வகிப்பது என்பதை விவரிக்கிறது மற்றும் CloudFormation, Terraform, Shell, PowerShell, Ansible, Chef மற்றும் Puppet மாதிரி code-ஐ வழங்குகிறது.

இது மாதிரி code என்பதையும், production சூழலில் எந்தவொரு பயன்பாட்டிற்கும் முன் development சூழலில் முழுமையாக சோதிக்கப்பட்டு validate செய்யப்பட வேண்டும் என்பதையும் நினைவில் கொள்ளவும்.
