...
# AWS Systems Manager மற்றும் tagging பயன்படுத்தி managed nodes-ஐ patch செய்தல்

## அறிமுகம்

உங்கள் node உள்கட்டமைப்பு முழுவதும் பாதுகாப்பு மற்றும் செயல்திறனை பராமரிக்க வலுவான patch management உத்தி தேவை. இந்த வழிகாட்டி தீர்வு [AWS Systems Manager](https://aws.amazon.com/systems-manager/) பயன்படுத்தி தானியங்கு, tag-அடிப்படையிலான patch management system-ஐ செயல்படுத்துவதில் உங்களை வழிநடத்தும். இந்த வழிகாட்டி தீர்வைப் பின்பற்றுவதன் மூலம், manual intervention-ஐ குறைக்கும் அதே வேளையில் security compliance-ஐ மேம்படுத்தும் scalable மற்றும் திறமையான patching process-ஐ நிறுவுவீர்கள். இந்த முறை centralized அணுகுமுறைக்கு [AWS Organizations](https://aws.amazon.com/organizations/)-க்குள் பயன்படுத்தலாம், மற்றும் single accounts-க்கும் செயல்படுத்தலாம்.

இது போன்ற tagging scheduling method-ஐ பயன்படுத்துவது application owners-க்கு தங்கள் nodes எப்போது updates பெறும் என்பதை நிர்வகிக்க அனுமதிக்கும். [patch policy](https://docs.aws.amazon.com/systems-manager/latest/userguide/quick-setup-patch-manager.html#create-patch-policy) கொண்ட அங்கீகரிக்கப்பட்ட schedules-ஐ [AWS CLI](https://aws.amazon.com/cli/) பயன்படுத்தி வினவலாம், இது node-ன் schedule-ஐ மாற்றுவதற்கான self-service முறையை அனுமதிக்கிறது.
