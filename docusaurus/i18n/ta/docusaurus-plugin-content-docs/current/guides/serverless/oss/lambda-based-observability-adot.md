# OpenTelemetry உடன் AWS Lambda அடிப்படையிலான Serverless Observability

இந்த வழிகாட்டி AWS X-Ray மற்றும் Amazon CloudWatch போன்ற நேட்டிவ் AWS கண்காணிப்பு சேவைகளுடன் நிர்வகிக்கப்படும் ஓப்பன் சோர்ஸ் கருவிகள் மற்றும் தொழில்நுட்பங்களைப் பயன்படுத்தி Lambda அடிப்படையிலான serverless பயன்பாடுகளுக்கு observability ஐ கட்டமைப்பதற்கான சிறந்த நடைமுறைகளை உள்ளடக்குகிறது. [AWS Distro for OpenTelemetry (ADOT)](https://aws-otel.github.io/docs/introduction), [AWS X-Ray](https://aws.amazon.com/xray) மற்றும் [Amazon Managed Service for Prometheus (AMP)](https://aws.amazon.com/prometheus/) போன்ற கருவிகளையும், உங்கள் serverless பயன்பாடுகளில் செயல்படக்கூடிய நுண்ணறிவுகளைப் பெறவும், சிக்கல்களைத் தீர்க்கவும், பயன்பாட்டு செயல்திறனை மேம்படுத்தவும் இந்தக் கருவிகளை எவ்வாறு பயன்படுத்தலாம் என்பதையும் நாங்கள் விவரிப்போம்.

## **உள்ளடக்கப்பட்ட முக்கிய தலைப்புகள்**

Observability சிறந்த நடைமுறைகள் வழிகாட்டியின் இந்த பிரிவில், பின்வரும் தலைப்புகளில் ஆழமாக ஆராய்வோம்:
...
## **AWS Distro for OpenTelemetry (ADOT) அறிமுகம்**
...
Open Source தொழில்நுட்பங்களைப் பயன்படுத்தும் AWS Lambda அடிப்படையிலான serverless பயன்பாட்டிற்கான இந்த observability சிறந்த நடைமுறை வழிகாட்டியில், AWS Distro for OpenTelemetry (ADOT) மற்றும் Lambda Layer பற்றியும் உங்கள் AWS Lambda functions களை இன்ஸ்ட்ருமென்ட் செய்ய அதை எவ்வாறு பயன்படுத்தலாம் என்பதையும் நாங்கள் விவரித்தோம். Auto-instrumentation ஐ எளிதாக செயல்படுத்துவது மற்றும் பல இலக்குகளுக்கு observability signals களை அனுப்ப எளிய configuration உடன் ADOT collector ஐ தனிப்பயனாக்குவது எப்படி என்பதை விவரித்தோம். ADOT ஐப் பயன்படுத்துவதன் நன்மைகள் மற்றும் தீமைகளையும், உங்கள் Lambda function க்கு cold start latency ஐ எவ்வாறு பாதிக்கலாம் என்பதையும் எடுத்துக்காட்டினோம், cold-start நேரங்களை நிர்வகிக்க சிறந்த நடைமுறைகளையும் பரிந்துரைத்தோம். இந்த சிறந்த நடைமுறைகளை ஏற்றுக்கொள்வதன் மூலம், விற்பனையாளர் agnostic வழியில் பல கண்காணிப்பு தீர்வுகளுக்கு logs, metrics மற்றும் traces களை அனுப்ப உங்கள் பயன்பாடுகளை ஒரே முறை இன்ஸ்ட்ருமென்ட் செய்யலாம்.

மேலும் ஆழமாக அறிய, [AWS One Observability Workshop](https://catalog.workshops.aws/observability/en-US) இன் AWS managed open-source Observability module ஐ பயிற்சி செய்ய மிகவும் பரிந்துரைக்கிறோம்.
