...
# JITNA உடன் EventBridge ஒருங்கிணைப்பு

Just-in-time node access (JITNA) ஐப் பயன்படுத்தும் போது, manual approval தேவைப்படும் session access request கள் உருவாக்கப்படும் போது [EventBridge](https://aws.amazon.com/eventbridge/) க்கு மூன்று வகையான events வெளியிடப்படுகின்றன:
...
:::info
உங்கள் auto-approval policy அடிப்படையில் தானாகவே அங்கீகரிக்கப்படும் access requests க்கு events வெளியிடப்படாது.
:::

## எடுத்துக்காட்டு event விவரங்கள்

### Requester access request event

`Requester Access Request Status Update` event க்கான event விவரங்களின் எடுத்துக்காட்டு கீழே உள்ளது.
...
<Tabs
    ...
    values={[
        {label: 'ஒப்புதல் நிலுவை', value: 'pending'},
        {label: 'அங்கீகரிக்கப்பட்டது', value: 'approved'},
    ]}>
...
`Approver Access Request Status Update` event க்கான event விவரங்களின் எடுத்துக்காட்டு கீழே உள்ளது.
...
### எடுத்துக்காட்டு OpsItem விவரங்கள்

Just-in-time node access requests [Systems Manager OpsItem resource](https://docs.aws.amazon.com/systems-manager/latest/APIReference/API_OpsItem.html) ஆக சேமிக்கப்படுகின்றன. Auto-approval policy ஆல் தானாகவே அங்கீகரிக்கப்பட்ட session access request க்கான OpsItem விவரங்களின் எடுத்துக்காட்டு கீழே உள்ளது.
