...
sidebar_position: 1
---
# மையப்படுத்தப்பட்ட patch compliance அறிக்கையிடல்

## Patch compliance என்றால் என்ன?

Patch compliance என்பது அனைத்து கணக்கீட்டு ஆதாரங்களும் நிறுவன policies களின்படி சமீபத்திய பாதுகாப்பு புதுப்பிப்புகள் மற்றும் பிழை திருத்தங்கள் நிறுவப்பட்டிருப்பதை உறுதிசெய்யும் செயல்முறையாகும். உங்கள் patch baseline இல் வரையறுக்கப்பட்ட அனைத்து தேவையான patches வெற்றிகரமாக பொருத்தப்பட்டிருக்கும் போது ஒரு அமைப்பு "patch compliant" என கருதப்படுகிறது. இணக்கமற்ற அமைப்புகளில் முக்கியமான பாதுகாப்பு புதுப்பிப்புகள் விடுபட்டிருக்கலாம், தீங்கிழைக்கும் நடிகர்களால் பயன்படுத்தப்படக்கூடிய பாதுகாப்பு பாதிப்புகளுக்கு உங்கள் நிறுவனத்தை வெளிப்படுத்தலாம்.

பல AWS accounts மற்றும் regions களை உள்ளடக்கிய நவீன கிளவுட் சூழல்களில், பரவலாக்கப்பட்ட patch management தெரிவுநிலை இடைவெளிகள், சீரற்ற அறிக்கையிடல், பாதிப்புகளுக்கு தாமதமான பதில்கள், சிக்கலான audit செயல்முறைகள் மற்றும் குழுக்கள் முழுவதும் நகல் முயற்சிகள் உட்பட குறிப்பிடத்தக்க சவால்களை உருவாக்குகிறது. இந்த சவால்கள் உங்கள் நிறுவனம் முழுவதும் நீட்டிக்கப்பட்ட பாதுகாப்பு வெளிப்பாடு மற்றும் ஆதாரங்களின் திறனற்ற பயன்பாட்டிற்கு வழிவகுக்கலாம்.

மையப்படுத்தப்பட்ட patch compliance அறிக்கையிடல் அனைத்து accounts மற்றும் regions களிலிருந்தும் தரவை ஒரே இடத்தில் ஒருங்கிணைப்பதன் மூலம் இந்த சவால்களை நிவர்த்தி செய்கிறது, உங்கள் பாதுகாப்பு நிலையின் விரிவான பார்வையை வழங்குகிறது. இந்த அணுகுமுறை பல நன்மைகளை வழங்குகிறது: compliance நிலைக்கான ஒற்றை source of truth, பாதிப்புகள் பற்றிய நிகழ்நேர விழிப்புணர்வு, சூழல்கள் முழுவதும் நிலையான மெட்ரிக்குகள், எளிமைப்படுத்தப்பட்ட auditing, போக்கு பகுப்பாய்வு திறன்கள், மேம்படுத்தப்பட்ட ஆதார திறன் மற்றும் தானியங்கி remediation workflows களுக்கான அடித்தளம்.

AWS Systems Manager patching செயல்முறைகளை தானியக்கமாக்க Patch Manager, compliance தரவை மைய S3 bucket இல் ஒருங்கிணைக்க [resource data syncs](https://docs.aws.amazon.com/systems-manager/latest/userguide/inventory-create-resource-data-sync.html) மற்றும் தரவை transform, query மற்றும் visualize செய்ய AWS Glue, Amazon Athena மற்றும் Amazon QuickSight போன்ற analytics சேவைகள் மூலம் இந்த மையப்படுத்தலுக்கான அடித்தளத்தை வழங்குகிறது. இந்த recipe இல் விவரிக்கப்பட்ட தீர்வு உங்கள் முழு AWS organization முழுவதும் செயல்படும் விரிவான அறிக்கையிடல் அமைப்பை உருவாக்க இந்த கூறுகளை பயன்படுத்துகிறது, மேலும் திறமையான செயல்பாடுகள் மற்றும் வேகமான பாதிப்பு remediation ஐ செயல்படுத்துகிறது.

:::tip
Resource data sync inventory மற்றும் patch compliance metadata ஐ JSON file வடிவத்தில் வழங்குகிறது. Athena மற்றும் QuickSight ஐப் பயன்படுத்துவதற்கு மாற்றாக, S3 bucket இலிருந்து தரவை pull செய்யக்கூடிய எந்த BI அல்லது analytics கருவியையும் பயன்படுத்தலாம்.
:::

## நோக்கம்

இந்த recipe இன் நோக்கம் மையப்படுத்தப்பட்ட patch compliance அறிக்கையிடலுக்கு தேவையான ஆதாரங்களை provision செய்ய பயன்படுத்தக்கூடிய மாதிரி CloudFormation templates களை வழங்குவதாகும். இந்த recipe patch scan அல்லது install operations களை deploy செய்வதை உள்ளடக்கவில்லை.
