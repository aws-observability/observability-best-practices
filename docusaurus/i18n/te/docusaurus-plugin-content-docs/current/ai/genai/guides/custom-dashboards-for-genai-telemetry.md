# GenAI టెలిమెట్రీ కోసం కస్టమ్ డాష్‌బోర్డ్‌లను సృష్టించడం

## కస్టమ్ డాష్‌బోర్డ్‌లు ఎందుకు?

Bedrock Model Invocation Logging ని ఎనేబుల్ చేసి ADOT auto-instrumentation agent ను డిప్లాయ్ చేసినప్పుడు, AWS మీకు అవుట్-ఆఫ్-ది-బాక్స్ డాష్‌బోర్డ్‌లతో ఒక హెడ్ స్టార్ట్ ఇస్తుంది. కానీ అది పూర్తి చిత్రం కాదు.
