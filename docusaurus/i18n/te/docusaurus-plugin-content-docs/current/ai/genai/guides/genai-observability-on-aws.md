# AWS లో GenAI Observability

## అవలోకనం

Generative AI వర్క్‌లోడ్‌లు సాంప్రదాయ అప్లికేషన్‌ల నుండి భిన్నంగా ఉంటాయి, మొదటి రోజు నుండి observability అవసరం. ప్రతిస్పందనలు నాన్-డిటర్మినిస్టిక్, ప్రాంప్ట్ సంక్లిష్టతతో latency నాటకీయంగా మారుతుంది, ఖర్చులు నేరుగా టోకెన్ వాడకంతో ముడిపడి ఉంటాయి.
