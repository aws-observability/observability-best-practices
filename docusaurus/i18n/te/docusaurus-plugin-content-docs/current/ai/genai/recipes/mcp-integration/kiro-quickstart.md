# Kiro IDE MCP Server - త్వరిత ప్రారంభ గైడ్

Kiro IDE లో నేరుగా సాదా ఆంగ్లంలో ప్రశ్నలు అడగండి - డాష్‌బోర్డ్‌లకు మారాల్సిన అవసరం లేదు లేదా సంక్లిష్ట క్వెరీలు రాయాల్సిన అవసరం లేదు!
