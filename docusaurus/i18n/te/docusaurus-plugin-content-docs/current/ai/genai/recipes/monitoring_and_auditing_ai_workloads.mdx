---
sidebar_position: 3
description: "CloudTrail, Bedrock Model Invocation Logging మరియు ADOT ఉపయోగించి AWS లో AI వర్క్‌లోడ్‌లను మానిటరింగ్ మరియు ఆడిటింగ్ చేయడానికి పూర్తి గైడ్."
...
# AWS లో AI వర్క్‌లోడ్‌లను మానిటరింగ్ మరియు ఆడిటింగ్ చేయడం
