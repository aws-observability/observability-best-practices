...
sidebar_position: 5
---
# CloudTrail నెట్‌వర్క్ యాక్టివిటీ ఈవెంట్‌లు

VPC ఎండ్‌పాయింట్‌ల కోసం నెట్‌వర్క్ యాక్టివిటీ ఈవెంట్‌లతో, మీ నెట్‌వర్క్‌లో రిసోర్స్‌లను ఎవరు యాక్సెస్ చేస్తున్నారో వివరాలను మీరు చూడవచ్చు.
