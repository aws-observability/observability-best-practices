# OpenTelemetry తో AWS Lambda ఆధారిత సర్వర్‌లెస్ Observability
...
## **AWS Distro for OpenTelemetry (ADOT) పరిచయం**
...
## **ADOT Lambda Layer ఉపయోగించడం యొక్క ప్రయోజనాలు మరియు అప్రయోజనాలు**
...
## **ADOT ఉపయోగించేటప్పుడు cold start latency ను నిర్వహించడం**
