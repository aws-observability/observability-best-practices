...
本指南探讨了 Application Signals 的技术架构、检测策略和实施方法，特别关注组织为什么应该从传统的 X-Ray 采样迁移到新的综合可观测性方案。
...
| [为什么要从 X-Ray 迁移](../why-migrate-from-xray) | 采用 Application Signals 和 Transaction Search 相比传统 X-Ray 的优势 |
