...
如果您是可观测性新手或需要有关如何设置 metrics、告警或制定可观测性策略的指导，[AWS 可观测性 Best Practices](https://aws-observability.github.io/aws-observability/) 概述了如何开始了解可观测性的不同组件以及哪些 metrics、告警等对监控有益。
