...
有关实施这些控制的详细指南（包括日志组层次结构设计、精细权限管理和加密最佳实践），请参阅 [CloudWatch Logs 安全最佳实践](https://aws-observability.github.io/aws-observability/tools/logs/security/cloudwatch-logs-security-best-practices/)。
