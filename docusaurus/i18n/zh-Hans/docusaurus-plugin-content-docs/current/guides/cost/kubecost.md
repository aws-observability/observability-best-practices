...
:::tip
    查看我们的 [One Observability Workshop](https://catalog.workshops.aws/observability/en-US/aws-managed-oss/amp/ingest-kubecost-metrics) 获取 Kubecost 的动手体验。
:::
...
### 参考资料
* [One Observability Workshop 上的 Kubecost 动手体验](https://catalog.workshops.aws/observability/en-US/aws-managed-oss/amp/ingest-kubecost-metrics)
