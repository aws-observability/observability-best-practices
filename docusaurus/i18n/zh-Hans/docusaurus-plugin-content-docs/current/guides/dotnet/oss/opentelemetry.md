...
1. **插桩** 包自动从各种 .NET 组件和流行库收集遥测数据，从 ASP.NET Core、HTTP 客户端和 Entity Framework 等源捕获 metrics、traces 和 logs。

1. **导出器** 包充当不同可观测性平台的桥梁，允许您将收集的遥测数据发送到各种目标，如 Jaeger、Prometheus 或任何支持 OTLP 协议的系统。
...
| [OpenTelemetry.Instrumentation.AspNetCore](https://github.com/open-telemetry/opentelemetry-dotnet-contrib/blob/main/src/OpenTelemetry.Instrumentation.AspNetCore/README.md)    | ASP.NET Core 和 Kestrel 的插桩    |
| [OpenTelemetry.Instrumentation.GrpcNetClient](https://github.com/open-telemetry/opentelemetry-dotnet-contrib/blob/main/src/OpenTelemetry.Instrumentation.GrpcNetClient/README.md)    | gRPC 客户端的插桩    |
| [OpenTelemetry.Instrumentation.Http](https://github.com/open-telemetry/opentelemetry-dotnet-contrib/blob/main/src/OpenTelemetry.Instrumentation.Http/README.md)    | HttpClient 和 HttpWebRequest 类的插桩    |
| [OpenTelemetry.Instrumentation.SqlClient](https://github.com/open-telemetry/opentelemetry-dotnet/tree/main/src/OpenTelemetry.Exporter.Console/README.md)    | SqlClient 的插桩，用于跟踪数据库操作（如 Entity Framework Core）    |
...
| [OpenTelemetry.Instrumentation.AWSLambda](https://github.com/open-telemetry/opentelemetry-dotnet-contrib/tree/main/src/OpenTelemetry.Instrumentation.AWSLambda)    | 用于插桩 AWS Lambda Handler 以创建传入 span 的 SDK 方法    |
