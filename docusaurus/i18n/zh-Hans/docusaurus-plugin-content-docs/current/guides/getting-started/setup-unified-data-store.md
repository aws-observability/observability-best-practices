...
除了跨账户 Observability 之外，您还可以将日志集中（复制）到中心区域和中心账户。
...
您可以将统一数据存储与跨账户 Observability 结合使用，也可以单独使用。

## 主要优势

- **集中所有 Observability 数据** – 将来自 AWS 服务和第三方来源的运营、安全和合规数据整合到跨多个账户和区域的统一存储中
