# 开发人员
Observability 对开发人员至关重要，它能提升生产力、改善应用程序性能，并通过更好的决策和更快的问题解决来推动业务成功。本指南提供了有效利用 Observability 的最佳实践和建议。

## 为什么 Observability 对开发人员很重要
开发人员使用 Observability 来实现以下关键目标：
- **快速识别和解决问题：**
    - Observability 使开发人员能够快速识别和诊断问题，减少解决问题的时间（MTTR），提高整体软件交付性能
    - 它帮助开发人员了解系统在生产环境中的行为，使他们能够做出明智的决策并改善运营
- **改善客户体验：**
    - 通过分析系统行为，开发人员可以优化性能和可靠性，从而带来更好的客户体验和更高的用户满意度
    - Observability 工具帮助监控用户交互，使开发人员能够及时识别和解决 UI/UX 问题
- **提升团队效率和创新能力：**
    - Observability 平台为运营数据提供单一事实来源，促进跨团队协作并减少故障排除时间
    - 得益于自动化洞察和告警，开发人员可以将更多精力放在创新上，减少手动调试的时间
- **数据驱动决策：**
    - Observability 提供系统性能的详细洞察，使开发人员能够就代码改进和资源分配做出数据驱动的决策
    - 它帮助组织优化投资并加速产品上市，通过识别需要改进的领域
- **复杂性管理：**
    - Observability 通过提供系统相互依赖关系的全面视图，帮助管理现代云原生和多云环境的复杂性
...
- 使用嵌入式指标格式（EMF）将指标嵌入日志中，减少对 Observability 平台的 API 调用次数，降低成本。
...
- **建议：**
    - **控制成本：**
        ...
        - **选择正确的信号：**
            ...
            - 运行 [Observability 策略研讨会](https://catalog.us-east-1.prod.workshops.aws/workshops/e31f4fcc-1944-4e46-815d-26fc9eafabce/en-US/5-practical-examples/5-1petstore-site-exercise/scenario1) 以确定应插桩到应用程序中的正确信号
    - **选择正确的信号：**
...
## 代码审查和协作策略
- **工单细化：**
    - 在功能细化过程中识别 Observability 需求。这可能包括
        - 受影响的利益相关者和相关 SLO
        - 所需的遥测/信号
        - 所需的告警
...
- **运营就绪审查：** 
    - 与平台和运维团队参加运营就绪审查，以识别 Observability 态势中的差距——这可以是一个清单和部署到生产环境前的强制性演练。对于拥有多个团队的大型组织，为避免此过程成为瓶颈，应根据新功能和发布节奏定期进行。
- **建议：**
