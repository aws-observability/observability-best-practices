...
*   [Amazon CloudWatch Log Transformation](https://www.youtube.com/watch?v=QMX9SG2P3q4) 了解如何轻松转换和分析您的日志数据。
...
*   [Operational Investigations with Amazon Q Developer](https://www.youtube.com/watch?v=Yvv056_RVqs) 了解如何使用 Amazon Q Developer 调查运营问题。
...
*   [Flow Monitoring with Amazon Network Flow Monitor](https://www.youtube.com/watch?v=_fFSv2tltqQ) 了解如何监控网络流量并识别潜在的安全威胁。
...
*   [OpenSearch SQL & PPL Query Languages Support in AWS CloudWatch Logs](https://www.youtube.com/watch?v=EMQQNpPa2Es)
    了解如何使用 OpenSearch SQL 和 PPL 编写强大的查询。
